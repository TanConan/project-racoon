...
public class GridMovement : MonoBehaviour, InputSystem.I_2DPlayerActions
{
    ...
    [Header("Movement finetuning")] public float movementSpeed = 5f;
    ...
    private void Update()
    {
        ...
        var moving = Vector3.Distance(transform.position, movePoint.transform.position) > 0.01f;
    ...
    private void ProcessInput()
    {
        ...
        if (direction != Vector3.zero) TryMove(direction);
    }
